...
SEARCH_ENGINE_PATTERNS = {
    # Enable some working search engines
    ...
    # Keep some commented out for testing
    ...
    #"tordex": "http://tordexyb63aknnvuzyqabeqx6l7zdiesfos22nisv6zbj6c6o3h6ijyd.onion/search?query={}",
    
    # New search engines - commented out until we verify their formats
...
KEYWORDS = [
    ...
    'childxxx', 'preteen', 'child', 'csam', 'csam viewer', 'csam access', 'watch child porn', 'view child porn', 'csam gallery', "loli", "boys", "girls", "teen", "young", "minor", "cp", "child porn", "childxxx", 
...
def generate_smart_search_queries():
    ...
    primary_keywords = ['cp', 'loli', 'child', 'teen', 'minor', 'preteen', 'lolita']
    ...
    # 4. Multi-word primary combinations
    ...
    # 6. Forum/community focused queries
    smart_queries.extend([
    ...
    return unique_queries[:50]  # Limit to top 50 most effective queries
